...
if [ -f "${ROOT_DIR}/repositories" ]; then
    sed -i 's|https://downloads.openwrt.org|https://mirrors.tuna.tsinghua.edu.cn/openwrt|g' "${ROOT_DIR}/repositories"
fi
if [ -f "${ROOT_DIR}/repositories.conf" ]; then
    sed -i 's|https://downloads.openwrt.org|https://mirrors.tuna.tsinghua.edu.cn/openwrt|g' "${ROOT_DIR}/repositories.conf"
fi
